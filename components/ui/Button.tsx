...
const BASE =
  "inline-flex min-h-12 items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-medium whitespace-nowrap";
...
const VARIANTS: Record<"primary" | "secondary", string> = {
  primary: "cta-primary bg-emerald text-emerald-dark",
  secondary:
