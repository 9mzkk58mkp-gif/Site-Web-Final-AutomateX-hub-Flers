...
export const PUBLIC_CHUNKS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    url: "/automatisations",
    text: "Automatisation des devis et de la gestion administrative pour artisans. Ce qui est installé : relance automatique des devis envoyés sans réponse, tri des mails entrants avec réponses pré-rédigées, prise de devis à la voix retranscrite automatiquement. Des systèmes simples qui tournent en arrière-plan. Tarif : sur devis, selon les systèmes mis en place (TVA non applicable, art. 293 B du CGI).",
  },
  {
    ...
    text: "Un devis envoyé sans relance est souvent un chantier perdu, pas parce que le client a dit non mais parce que personne n'a relancé au bon moment. Le système suit automatiquement les devis sans réponse et relance au bon moment, l'artisan garde la main et peut intervenir à tout moment.",
  },
  {
    ...
    text: "Entre demandes de devis, factures fournisseurs et mails publicitaires, la boîte mail d'un artisan devient vite un fouillis. Les mails sont automatiquement triés par type, les demandes de devis mises en avant en priorité, des réponses brouillon préparées pour les demandes courantes.",
  },
  {
    ...
    text: "Sur un chantier, prendre des notes pour un devis n'est pas toujours pratique. L'artisan dicte les informations depuis son téléphone, le système retranscrit et structure automatiquement, une base de devis prête à finaliser sans ressaisie.",
  },
  {
    id: "qui-je-suis",
    tier: "public",
