      ...
      <article className="mx-auto max-w-3xl px-4 pt-16 pb-24">
        <Reveal>
          ...
          <p className="mt-6 text-base text-text-secondary">
            La manière la plus rapide de me joindre, c&apos;est le téléphone ou WhatsApp. Je
            réponds personnellement — pas de standard, pas de formulaire qui atterrit nulle part.
          </p>
